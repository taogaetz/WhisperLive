<!--
Historical README from Collabora/WhisperLive, preserved for source attribution
and reference. It describes the upstream project, not the current PascalScribe
runtime. See README.md for current documentation.
-->
